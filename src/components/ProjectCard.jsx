  ...
  return (
    <div className="group bg-white dark:bg-gray-800 rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl project-card border border-gray-100 dark:border-gray-700">
      <div className="relative overflow-hidden h-48">
        {/* blurred full-bleed background using same image */}
        <div
          aria-hidden="true"
          className="absolute inset-0 bg-center bg-cover transform scale-105 filter blur-lg opacity-60"
          style={{ backgroundImage: `url(${project.image})` }}
        ></div>

        {/* main image — crisp, centered, fits container */}
        <img
          src={project.image}
          alt={project.title}
          loading="lazy"
          className="relative w-full h-48 object-cover group-hover:scale-110 transition-transform duration-500 z-10"
        />
